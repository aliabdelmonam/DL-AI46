...
class Model(nn.Module):
  ...
  def fit(self, x: torch.Tensor, y: torch.Tensor, criterion: nn.Module, optimizer: Optimizer, epochs: int = 100, reset_weights: bool = False, x_val: torch.Tensor = None, y_val: torch.Tensor = None, metric_fn = None):
    if reset_weights:
